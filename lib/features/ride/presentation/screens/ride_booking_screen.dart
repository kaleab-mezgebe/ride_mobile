...
import '../../../driver/presentation/screens/driver_screen.dart';
          ...
          drawer: DrawerMenu(
            ...
            onRideHistory: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (_) => const RideHistoryScreen(phone: ''),
                ),
              );
            },
            onNotifications: () {
                          ...
                          isActive
                              ? () async {
                                if (_pickupPoint != null &&
                                  ...
                                  // Navigate to driver screen after 1-second delay
                                  Future.delayed(
